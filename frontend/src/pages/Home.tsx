    ...
    <main className="flex flex-col min-h-screen">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 pt-28 pb-16 relative">
        ...
        <p className="mt-8 text-ink-500 text-sm max-w-md leading-relaxed">
          {t('home.description1')}{' '}
          <strong className="text-ink-800">{t('home.original')}</strong>{' '}
          {t('home.or')}{' '}
          <strong className="text-ink-800">{t('home.fake')}</strong>.
        </p>
      </section>
      ...
      {/* Features */}
      <section className="grid sm:grid-cols-3 gap-5 max-w-6xl mx-auto w-full px-6 py-20">
        {[
          {
            icon: <ShieldCheck size={26} className="text-gold-500" />,
            tag: '01',
            title: t('home.features.0.title'),
            desc: t('home.features.0.description'),
          },
          {
            icon: <Trophy size={26} className="text-gold-500" />,
            tag: '02',
            title: t('home.features.1.title'),
            desc: t('home.features.1.description'),
          },
          {
            icon: <Users size={26} className="text-gold-500" />,
            tag: '03',
            title: t('home.features.2.title'),
            desc: t('home.features.2.description'),
          },
        ].map((f) => (
      ...
      <section className="bg-ink-900 py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="section-label text-cream-300 mb-4">{t('home.ready')}</p>
          ...
          >
            <Zap size={16} className="text-gold-500" /> {t('home.verify')}
          </button>
        </div>
      </section>
    </main>
